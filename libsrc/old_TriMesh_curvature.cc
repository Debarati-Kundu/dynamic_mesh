...
void TriMesh::need_gauss_curvatures()
{
	...
	need_adjacentfaces();
//	i = 1;
//	dprintf("\nvertices i %lf %lf %lf",vertices[i][0], vertices[i][1], vertices[i][2]);
	for (i = 0; i < nv; i++) {
...
//			dprintf("\n");
			...
			for (k = 0; k < 3; k++) {
//			dprintf(" face vert %d",faces[adjacentfaces[i][j]][k]);
...
//			dprintf("\nv1 %lf %lf %lf",v1[0], v1[1], v1[2]);
//			dprintf("\nv2 %lf %lf %lf",v2[0], v2[1], v2[2]);
//			dprintf("\nv3 %lf %lf %lf",v3[0], v3[1], v3[2]);
...
//			dprintf("\narg %lf %d\n\n",arg, vert_indicator);
		...
		if (gauss_curv[i] < -0.001)  neg_count++;
	//	dprintf("*");
